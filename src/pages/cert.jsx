...
const [ZoneNo, setZoneNo] = useState("");
  ...
  const encryptedQRCodeValue = encryptData(
    ...
    account_id // Use the account_id as the password
  );
    ...
    <div className="cert-wrapper">
      ...
      <div className="container" ref={ref}>
        ...
        <div className="content">
          {/* Header Section with Logos and Content */}
      ...
      <div className="logo1">
        ...
        <img src={logo2} />
          ...
          <h2>
            This is to CERTIFY that per records available in this Office,{" "}
            <strong>{last_name}, {extension} {first_name} {middle_name}</strong> is a bonafide resident of this Barangay since birth.
          </h2>

          <h3>
            This further certifies that the above-named person has no pending and or derogatory record file against him/her as of this date.
          </h3>

          <h4>
            This certification is issued upon the request of the above-named person to support his/her{" "}
            <strong>{purpose}</strong>.
          </h4>

          <h6>
            Issued on this <strong>{date}</strong>, at Barangay Rorogagus East, Marawi City, Lanao Del Sur, 9700
          </h6>

          <h5><strong>{account_id}|{HouseNo}{ZoneNo}</strong></h5>
